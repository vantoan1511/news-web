...
<header id="header" class="header fixed-top d-flex align-items-center">
	...
	<div class="d-flex align-items-center justify-content-between">
		<a href="<c:url value='/admin-home'/>" class="logo d-flex align-items-center"> <img
			src="${pageContext.request.contextPath}/template/admin/assets/img/logo.png"
			alt=""> <span class="d-none d-lg-block">Trang quản trị</span>
			...
			<li class="nav-item dropdown pe-3"><a
				...
				<ul
					...
					<li class="dropdown-header">
						<h6>Kevin Anderson</h6> <span>Admin</span>
					</li>
					<li>
