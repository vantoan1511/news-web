				...
				<div class="col-md-8 col-sm-12 col-xs-12">
					<div class="headline">
						...
						<div class="owl-carousel owl-theme" id="headline">
							<div class="item">
								<a href="#">
									<div class="badge">Tip!</div> Vestibulum ante ipsum primis in
									faucibus orci
								</a>
							</div>
							<div class="item">
					...
					<div class="owl-carousel owl-theme slide" id="featured">
						<div class="item">
							<article class="featured">
								...
								<figure>
									<img
										src="${pageContext.request.contextPath}/template/web/images/news/img04.jpg"
										alt="Sample Article">
								</figure>
								<div class="details">
									<div class="category">
						...
						<div class="item">
							<article class="featured">
								...
								<figure>
									<img
										src="${pageContext.request.contextPath}/template/web/images/news/img14.jpg"
										alt="Sample Article">
								</figure>
								<div class="details">
									<div class="category">
									...
									<h1>
										<a href="single.html">Class aptent taciti sociosqu ad
											litora torquent per conubia nostra</a>
									</h1>
						...
						<div class="item">
							<article class="featured">
								...
								<figure>
									<img
										src="${pageContext.request.contextPath}/template/web/images/news/img13.jpg"
										alt="Sample Article">
								</figure>
								<div class="details">
									<div class="category">
						...
						<div class="item">
							<article class="featured">
								...
								<figure>
									<img
										src="${pageContext.request.contextPath}/template/web/images/news/img05.jpg"
										alt="Sample Article">
								</figure>
								<div class="details">
									<div class="category">
							...
							<div class="row">
									...
									<div class="inner">
										<figure>
											<a href="single.html"> <img
												src="${pageContext.request.contextPath}/template/web/images/news/img10.jpg"
												alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
								...
								<article class="article col-md-12">
									<div class="inner">
										<figure>
											<a href="single.html"> <img
												src="${pageContext.request.contextPath}/template/web/images/news/img06.jpg"
												alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
							...
							<div class="row">
								<article class="article col-md-12">
									<div class="inner">
										...
										<div class="padding">
											...
											<h2>
												<a href="single.html">Mauris elementum libero at
													pharetra auctor</a>
											</h2>
								...
								<article class="article col-md-12">
									<div class="inner">
										<figure>
											<a href="single.html"> <img
												src="${pageContext.request.contextPath}/template/web/images/news/img07.jpg"
												alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
											...
											<h2>
												<a href="single.html">Sed do eiusmod tempor incididunt
													ut labore</a>
											</h2>
					...
					<div class="banner">
						<a href="#"> <img
							src="${pageContext.request.contextPath}/template/web/images/ads.png"
							alt="Sample Article">
						</a>
					</div>
							...
							<div class="body-col vertical-slider" data-max="4"
								...
								<article class="article-mini">
									<div class="inner">
										<figure>
											<a href="single.html"> <img
												src="${pageContext.request.contextPath}/template/web/images/news/img09.jpg"
												alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
								...
								<article class="article-mini">
									<div class="inner">
										<figure>
											<a href="single.html"> <img
												src="${pageContext.request.contextPath}/template/web/images/news/img01.jpg"
												alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
								...
								<article class="article-mini">
									<div class="inner">
										<figure>
											<a href="single.html"> <img
												src="${pageContext.request.contextPath}/template/web/images/news/img02.jpg"
												alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
								...
								<article class="article-mini">
									<div class="inner">
										<figure>
											<a href="single.html"> <img
												src="${pageContext.request.contextPath}/template/web/images/news/img08.jpg"
												alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
					...
					<div class="row">
						<article class="col-md-12 article-list">
							<div class="inner">
								<figure>
									<a href="single.html"> <img
										src="${pageContext.request.contextPath}/template/web/images/news/img11.jpg"
										alt="Sample Article">
									</a>
								</figure>
								<div class="details">
						...
						<article class="col-md-12 article-list">
							<div class="inner">
								<figure>
									<a href="single.html"> <img
										src="${pageContext.request.contextPath}/template/web/images/news/img03.jpg"
										alt="Sample Article">
									</a>
								</figure>
								<div class="details">
				...
				<div class="col-xs-6 col-md-4 sidebar" id="sidebar">
									...
									<div class="featured-author-cover"
										...
										<div class="featured-author-center">
											<figure class="featured-author-picture">
												<img
													src="${pageContext.request.contextPath}/template/web/images/img01.jpg"
													alt="Sample Article">
											</figure>
										...
										<div class="block">
											...
											<div class="block-body">
												<ul class="item-list-round" data-magnific="gallery">
													<li><a
														href="${pageContext.request.contextPath}/template/web/images/news/img06.jpg"
														style="background-image: url('images/news/img06.jpg');"></a>
													</li>
													<li><a
														href="${pageContext.request.contextPath}/template/web/images/news/img07.jpg"
														style="background-image: url('images/news/img07.jpg');"></a>
													</li>
													<li><a
														href="${pageContext.request.contextPath}/template/web/images/news/img08.jpg"
														style="background-image: url('images/news/img08.jpg');"></a>
													</li>
													<li><a
														href="${pageContext.request.contextPath}/template/web/images/news/img09.jpg"
														style="background-image: url('images/news/img09.jpg');"></a>
													</li>
													<li><a
														href="${pageContext.request.contextPath}/template/web/images/news/img10.jpg"
														style="background-image: url('images/news/img10.jpg');"></a>
													</li>
													<li><a
														href="${pageContext.request.contextPath}/template/web/images/news/img11.jpg"
														style="background-image: url('images/news/img11.jpg');"></a>
													</li>
													<li><a
														href="${pageContext.request.contextPath}/template/web/images/news/img12.jpg"
														style="background-image: url('images/news/img12.jpg');">
															<div class="more">+2</div>
													</a></li>
													<li class="hidden"><a
														href="${pageContext.request.contextPath}/template/web/images/news/img13.jpg"
														style="background-image: url('images/news/img13.jpg');"></a>
													</li>
													<li class="hidden"><a
														href="${pageContext.request.contextPath}/template/web/images/news/img14.jpg"
						...
						<div class="aside-body">
							...
							<article class="article-mini">
								<div class="inner">
									...
									<div class="padding">
										<h1>
											<a href="single.html">neque est semper nulla, ac
												elementum risus quam a enim</a>
										</h1>
									</div>
								</div>
							</article>
							...
							<div class="tab-pane active" id="recomended">
								<article class="article-fw">
									<div class="inner">
										<figure>
											<a href="single.html"> <img
												src="${pageContext.request.contextPath}/template/web/images/news/img16.jpg"
												alt="Sample Article">
											</a>
										</figure>
										<div class="details">
											...
											<p>Donec congue turpis vitae mauris condimentum luctus.
												Ut dictum neque at egestas convallis.</p>
										</div>
									</div>
								</article>
								<div class="line"></div>
					...
					<aside id="sponsored">
						...
						<div class="aside-body">
							<ul class="sponsored">
								<li><a href="#"> <img
										src="${pageContext.request.contextPath}/template/web/images/sponsored.png"
										alt="Sponsored">
								</a></li>
								<li><a href="#"> <img
										src="${pageContext.request.contextPath}/template/web/images/sponsored.png"
			...
			<div class="owl-carousel owl-theme carousel-1">
				...
				<article class="article">
					<div class="inner">
						<figure>
							<a href="single.html"> <img
								src="${pageContext.request.contextPath}/template/web/images/news/img15.jpg"
								alt="Sample Article">
							</a>
						</figure>
						<div class="padding">
				...
				<article class="article">
					<div class="inner">
						...
						<div class="padding">
							...
							<p>Proin venenatis pellentesque arcu, ut mattis nulla
								placerat et.</p>
						</div>
					</div>
				</article>
